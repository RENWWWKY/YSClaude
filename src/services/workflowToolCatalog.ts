export const WORKFLOW_TOOL_NAMES = [
  ...
  'artifact_list', 'artifact_read', 'artifact_write', 'artifact_delete', 'artifact_show_card', 'artifact_upload_to_server', 'artifact_download_from_server',
  'web_search', 'get_hotboard', 'webview_open', 'webview_eval_js', 'webview_screenshot', 'html_artifact_open', 'html_artifact_observe', 'html_artifact_interact', 'html_artifact_screenshot',
...
const WORKFLOW_TOOL_DESCRIPTION_MAP: Record<string, string> = {
  ...
  artifact_list: '列出当前对话中的文件与制品。', artifact_read: '读取制品内容。', artifact_write: '创建、整体替换或局部修改对话文件。', artifact_delete: '删除指定制品。', artifact_show_card: '在对话中展示制品卡片。', artifact_upload_to_server: '把制品上传到服务器。', artifact_download_from_server: '从服务器下载制品。',
  web_search: '搜索互联网并返回相关结果。', get_hotboard: '查看指定平台的热榜。', webview_open: '在内置网页中打开链接。', webview_eval_js: '在当前网页执行 JavaScript。', webview_screenshot: '截取当前网页画面。', html_artifact_interact: '点击 HTML 元素、坐标或等待页面更新。', html_artifact_edit: '整体替换或局部修改 HTML 预览。',
